        ...
        "storylets": [
            {
                ...
                "choices": [{"label": "Look around", "set": {"observation": 1}}],
                "weight": 1.0,
            }
        ]
    }
...
def test_world_generation_improvement():
    ...
    assert (
        "auto_improvements" in result
    ), "Expected auto_improvements in world generation response"
...
def test_populate_improvement():
    ...
    assert (
        "auto_improvements" in result
    ), "Expected auto_improvements in population response"
