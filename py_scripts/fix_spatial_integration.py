...
class SpatialIntegrator:
    ...
    def analyze_current_state(self):
        ...
        print(
            f"Existing locations: {len([loc for loc in location_count.keys() if loc != 'No Location'])}"
        )
    ...
    def create_movement_connections(self):
        ...
        for i, location in enumerate(locations):
            ...
            if storylets_in_location:
                representative = storylets_in_location[
                    0
                ]  # Use first storylet as representative
    ...
    def verify_spatial_network(self):
        ...
        return {
            "located_storylets": located_count,
